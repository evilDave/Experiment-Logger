...
// Antenna
#define COCOAPODS_POD_AVAILABLE_Antenna
#define COCOAPODS_VERSION_MAJOR_Antenna 2
#define COCOAPODS_VERSION_MINOR_Antenna 0
#define COCOAPODS_VERSION_PATCH_Antenna 0
